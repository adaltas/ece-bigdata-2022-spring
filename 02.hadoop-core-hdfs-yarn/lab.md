...
1. Create a directory named after your `$USER` in your group HDFS directory. E.g. `/education/ece_2022_spring_app_1/$USER`
...
1. Look at the content of the input directory we will use: `/education/ece_2022_spring_app_1/resources/lab2`
2. Run the command:
   ```bash
   yarn jar /usr/hdp/current/hadoop-mapreduce-client/hadoop-mapreduce-examples-3.1.1.3.1.0.0-78.jar \
    wordcount /education/ece_2022_spring_app_1/resources/lab2 \
    /education/ece_2022_spring_app_1/$USER/lab2/output-moby-dick
   ```
